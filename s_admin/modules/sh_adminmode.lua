...
sAdmin.AdminMode.Config.AdminModeModel = "models/bratplat/cuadrado/cuadrado_colorized.mdl" -- This is the playermodel the admin will have when in admin mode, leave blank to disable.

sAdmin.AdminMode.Config.AdminModeJob = "Staff On Duty" -- Leave blank to disable, this will change your job to the selected one. (Make it the job name)
